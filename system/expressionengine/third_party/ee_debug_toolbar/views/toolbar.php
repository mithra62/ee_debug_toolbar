...
<div id="EEDebug_debug">
	...
	<div id="EEDebug_info">
		<span class="EEDebug_span clickable" data-target="EEDebug_copyright">
			<img src="<?php echo $theme_url."images/logo.png" ?>" style="vertical-align:middle" alt="<?php echo lang('credits'); ?>" title="<?php echo lang('credits'); ?>">  v<?=APP_VER?> <?php //echo ' - '; echo lang('build'). '&nbsp;'.APP_BUILD;?>/<?php echo phpversion(); ?>
		</span>
		<span class="EEDebug_span clickable" data-target="EEDebug_variables">
			<img src="<?php echo $theme_url."images/variables.png" ?>" style="vertical-align:middle" alt="<?php echo lang('variables'); ?>" title="<?php echo lang('variables'); ?>">  <?php echo lang('variables'); ?>
		</span>
		<span class="EEDebug_span clickable" data-target="EEDebug_file">
			<img src="<?php echo $theme_url."images/files.png" ?>" style="vertical-align:middle" alt="<?php echo lang('files'); ?>" title="<?php echo lang('files'); ?>"> <?php echo count(get_included_files()); ?> <?php echo lang('files'); ?>
		</span>
		<span class="EEDebug_span clickable" data-target="EEDebug_memory">
			<img src="<?php echo $theme_url."images/memory.png" ?>" style="vertical-align:middle" alt="<?php echo lang('memory'); ?>" title="<?php echo lang('memory'); ?>"> <?php echo $memory_usage; ?> of <?php echo ini_get('memory_limit'); ?>
		</span>
		<span class="EEDebug_span clickable" data-target="EEDebug_time">
			<img src="<?php echo $theme_url."images/time.png" ?>" style="vertical-align:middle" alt="<?php echo lang('time'); ?>" title="<?php echo lang('time'); ?>"> <?php echo $elapsed_time; ?>s
		</span>
		<span class="EEDebug_span clickable" data-target="EEDebug_registry">
			<img src="<?php echo $theme_url."images/config.png" ?>" style="vertical-align:middle" alt="<?php echo lang('configuration_data'); ?>" title="<?php echo lang('configuration_data'); ?>">  <?php echo lang('config'); ?> (<?php echo count($config_data); ?>)
		</span>
		<span class="EEDebug_span clickable" data-target="EEDebug_database">
			<img src="<?php echo $theme_url."images/db.png" ?>" style="vertical-align:middle" alt="<?php echo lang('database'); ?>" title="<?php echo lang('database'); ?>"> <?php echo $query_count; ?> <?php echo lang('in'); ?> <?php echo $query_data['total_time']; ?>s
		</span>
