...
<div id="EEDebug_debug">
	...
	<div id="EEDebug_file" class="EEDebug_panel">
		...
		<?php echo count(get_included_files()); ?> Files Included<br>

		<h4>System Paths</h4>
		App: <?php echo APPPATH ; ?><br>
		Themes: <?php echo PATH_THEMES ; ?><br>
		Third Party: <?php echo PATH_THIRD; ?><br>
		Third Party Themes: <?php echo PATH_MBR_THEMES; ?><br>
		<?php if(defined('Javascript')): ?>
		Javascript: <?php echo PATH_JAVASCRIPT; ?><br>
		<?php endif; ?>
	...
	<div id="EEDebug_registry" class="EEDebug_panel">
 	...
 	<div id="EEDebug_database" class="EEDebug_panel">
 		...
 		Query cache is <?php echo ($config_data['enable_db_caching'] == 'y' ? 'ENABLED' : 'DISABLED'); ?>
 		<h4>Adapter 0</h4>
 		<ol>
